...
# 加载 XML 文件
scene_number = 184
# asset_root = "skillmimic/data/assets/mjcf/parahome"
# asset_file = f"s{scene_number}.xml"
asset_root = "skillmimic/data/assets/mjcf"
asset_file = "mocap_parahome_boxhand_s22.xml"
