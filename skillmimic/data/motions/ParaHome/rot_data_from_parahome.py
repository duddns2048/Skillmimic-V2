...
# scene_numbers = [79,89,98,99,108,110,113,114,117,149,184]
scene_numbers = [98]
...
for scene_number in scene_numbers:
    ...
    skeleton_hierachy = parse_skeleton('skillmimic/data/assets/mjcf/mocap_parahome_boxhand.xml')
    ...
    print(f"Save local body rotations for scene {scene_number} successfully!")