...
CHECKPOINT=${1:-"output/output_1120_0623/SkillMimic_17-04-53-37_pan/nn/SkillMimic_e16012_r38.8180.pth"}
...
--motion_file skillmimic/data/motions/ParaHome/wristmimic/s117_move_pan \
--asset_file_name mjcf/parahome/s117.xml \
--in_scene_obj_static gasstove,diningtable \
--in_scene_obj_dynamic pan \
